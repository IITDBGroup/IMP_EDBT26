...
def main(args):
    ...
    if True:
        ...
        psql_run(f'create table dy{PREFIX}_delta as select * from edb1 where id = 1;')
        ...
        for line in indLines:
            ...
            batchF.write(f'insert into dy{PREFIX}_delta select *, -1, {lineCells[0]} from edb1 where a = {randVal};\n')
            batchF.close()
